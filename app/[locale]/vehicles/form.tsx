    ...
    const onSubmit = async (data: FormValues) => {
        try {
            ...
            const excelData = data.vehicles.map((vehicle) => {
                ...
                if (armoredVehicleCertificatesFolder && vehicle.armoredVehicleCertificate && armoredVehicleCertificateName) {
                ...
                return {
                    ...
                    "Related Persons": Array.isArray(vehicle.relatedPersons) ? vehicle.relatedPersons.join(',') : vehicle.relatedPersons,
                    "ID Document Number": vehicle.senewiyahNumber,
                    "Associated PCH Contract Number": vehicle.associatedPetroChinaContractNumber,
                    "Contract Holding PCH Department": vehicle.contractHoldingPetroChinaDepartment,
                    "Comments": "",
            ...
            const combinedData = [...headerText, headers, ...excelData.map(obj => Object.values(obj).slice(0, -2))];
            ...
            zip.file(`${excelData[0]["Company Name"]} - ${excelData.length} vehicles request.xlsx`, excelBuffer);
            ...
            const excelDataValues = excelData.map((data, index) => {
                return {
                    ...
                    "Driver 1": data["Related Persons"] ? data["Related Persons"].split(',')[0] : "",
                    "Driver 2": data["Related Persons"] ? data["Related Persons"].split(',')[1] : "",
                    "Driver 3": data["Related Persons"] ? data["Related Persons"].split(',')[2] : "",
                    "Driver 4": data["Related Persons"] ? data["Related Persons"].split(',')[3] : "",
                    "Driver 5": data["Related Persons"] ? data["Related Persons"].split(',')[4] : "",
                    "Driver 6": data["Related Persons"] ? data["Related Persons"].split(',')[5] : "",
                    "Driver 7": data["Related Persons"] ? data["Related Persons"].split(',')[6] : "",
                    "Driver 8": data["Related Persons"] ? data["Related Persons"].split(',')[7] : "",
                    "Driver 9": data["Related Persons"] ? data["Related Persons"].split(',')[8] : "",
                    "Driver 10": data["Related Persons"] ? data["Related Persons"].split(',')[9] : "",
                    "Driver 11": data["Related Persons"] ? data["Related Persons"].split(',')[10] : "",
                    "Driver 12": data["Related Persons"] ? data["Related Persons"].split(',')[11] : "",
                    "Driver 13": data["Related Persons"] ? data["Related Persons"].split(',')[12] : "",
                    "Driver 14": data["Related Persons"] ? data["Related Persons"].split(',')[13] : "",
                    "Driver 15": data["Related Persons"] ? data["Related Persons"].split(',')[14] : "",
                    "Driver 16": data["Related Persons"] ? data["Related Persons"].split(',')[15] : "",
                    "Driver 17": data["Related Persons"] ? data["Related Persons"].split(',')[16] : "",
                    "Driver 18": data["Related Persons"] ? data["Related Persons"].split(',')[17] : "",
                    "Driver 19": data["Related Persons"] ? data["Related Persons"].split(',')[18] : "",
                    "Driver 20": data["Related Persons"] ? data["Related Persons"].split(',')[19] : "",
            ...
            try {
                ...
                const vehicles = await Promise.all(dataRows.map(async (row: any) => {
                    ...
                    return {
                        ...
                        armoredVehicleCertificate: armoredVehicleCertificateFile ? new File([await armoredVehicleCertificateFile.async('blob')], armoredVehicleCertificateFile.name, { type: 'image/jpeg' }) : undefined,
                    };
                }));
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit, (errors) => {
                        ...
                        <Tabs
                            ...
                            dir={isRTL ? 'rtl' : 'ltr'}
                        >
                            <TabsList className="flex justify-start gap-x-2 bg-green-50 items-center p-2 container overflow-x-scroll h-auto scroll-smooth scrollbar flex-row">
                                ...
                                >
                                    <CardHeader className="">
                                        <div className="flex justify-between items-center">
                                            <CardTitle>{formTranslations('vehicle')} {index + 1} {formTranslations('details')}</CardTitle>
                                            {fields.length > 1 && (
                                                <Button
                                                    type="button"
                                                    variant="outline"
                                            ...
                                            <div className="grid grid-cols-1 gap-4">
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('make')}</FormLabel>
                                                                <FormControl>
                                                                    <Input {...field} />
                                                                </FormControl>
                                                                <FormDescription>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('model')}</FormLabel>
                                                                <FormControl>
                                                                    <Input {...field} />
                                                                </FormControl>
                                                                <FormDescription>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('contractor')}</FormLabel>
                                                                <FormControl>
                                                                    <Input {...field} />
                                                                </FormControl>
                                                                <FormDescription>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('province')}</FormLabel>
                                                                <Select
                                                                    dir={isRTL ? 'rtl' : 'ltr'}
                                                                ...
                                                                >
                                                                    <FormControl>
                                                                        <SelectTrigger>
                                                                            <SelectValue placeholder={formTranslations('selectProvince')} />
                                                                        </SelectTrigger>
                                                                    </FormControl>
                                                                    <SelectContent>
                                                                        {provinces.map((province) => (
                                                                            <SelectItem
                                                                                ...
                                                                                value={province.name}
                                                                            >
                                                                                {locale === 'ar' ? province.name_ar : locale === 'cn' ? province.name_cn : province.name}
                                                                            </SelectItem>
                                                                        ))}
                                                                    </SelectContent>
                                                                </Select>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('senewiyahNumber')}</FormLabel>
                                                                <FormControl>
                                                                    <Input {...field} />
                                                                </FormControl>
                                                                <FormDescription>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('wakalaNumber')}</FormLabel>
                                                                <FormControl>
                                                                    <Input {...field} />
                                                                </FormControl>
                                                                <FormDescription>
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('softskinArmored')}</FormLabel>
                                                                <FormControl>
                                                                    <Select 
                                                                        onValueChange={field.onChange}
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <SelectContent>
                                                                            <SelectItem value="Softskin">Softskin</SelectItem>
                                                                ...
                                                                <div className="space-y-3">
                                                                    <div className="flex flex-wrap gap-2 p-4 border-2 border-dashed rounded-lg min-h-[80px] bg-gray-50/50 transition-all hover:border-gray-400">
                                                                        {field.value && field.value.length > 0 ? (
                                                                            field.value.map((person: string, personIndex: number) => (
                                                                                <div 
                                                                                    key={personIndex} 
                                                                    ...
                                                                    <div className="relative">
                                                                        <Input
                                                                            placeholder={formTranslations('enterHFYCNumber')}
                                                                            ...
                                                                            onKeyDown={(e) => {
                                                                                if (e.key === 'Enter') {
                                                                                    ...
                                                                                    const isValidFormat = /^HFYC\d{4}$/.test(value);
                                                                                    const isDuplicate = field.value?.includes(value);
                                                                                    const isAtLimit = field.value?.length >= 20;
                                                                                    
                                                                                    if (!isValidFormat) {
                                                                                        toast({
                                                                                            title: "⚠️ Invalid Format",
                                                                                            description: "Please use format HFYC0001",
                                                                                            variant: "destructive"
                                                                                        });
                                                                                    ...
                                                                                    if (isDuplicate) {
                                                                                        toast({
                                                                                            ...
                                                                                            description: "This HFYC number is already in the list",
                                                                                            variant: "destructive"
                                                                                        });
                                                                                        return;
                                                                                    }
                                                                                    ...
                                                                                    if (isAtLimit) {
                                                                                        toast({
                                                                                            ...
                                                                                            description: "Maximum 20 HFYC numbers allowed",
                                                                                            variant: "destructive"
                                                                                        });
                                                                                        return;
                                                                                    }
                                                                        ...
                                                                        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2 text-sm text-gray-400">
                                                                            <span className="px-2 py-1 rounded-md bg-gray-100">Enter ↵</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                                                    ...
                                                    <FormField
                                                        ...
                                                        render={({ field }: { field: any }) => (
                                                            <FormItem>
                                                                <FormLabel>{formTranslations('armoredVehicleCertificate')}</FormLabel>
                                                                <FormControl>
                                                                    <CustomFileUpload
                                                                        initialFile={field.value}
                                                                        onChange={(file: any) =>
                                                                        ...
                                                                        label={formTranslations('uploadArmoredVehicleCertificate')}
                                                                    />
                                                                </FormControl>
                                                                <FormDescription>
                                                                    {formDescriptions('uploadArmoredVehicleCertificate')}
                                                                </FormDescription>
                                                                <FormMessage />
                                                            </FormItem>
                                                        )}
